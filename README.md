...
<p align="center">
Менеджер маркетплейсов Wildberries и Ozon, начинающий разработчик (Go, Python, Telegram‑боты) и изучающий дизайн. Создаю продукты, улучшаю карточки товаров и постоянно учусь.
</p>
...
- **Инструменты и технологии:** Git, Docker, Telegram Bot API, HTML/CSS
